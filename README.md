...
**Flight Search:** Search for flights based on various criteria like departure city, destination city, departure date, and class.
**Booking Management:** Book flights, view all bookings, and filter bookings by user.
**Payment Integration:** Create payment intents for bookings.
...
7. **Frontend URL**:
    - The `FRONTEND_URL` should point to the URL where your frontend application is running (typically `http://localhost:8000` if you're running it locally).
